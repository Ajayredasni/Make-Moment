<?php
   ...
   //     $Business_image_name=$post['Business_image_name']
   //     $Business_Description=$_POST['Business_Description'];
   
   //     $sql_add ="INSERT INTO add_business VALUES('$Business_name','$Business_Email_id','$Event_related_your_categories','$Username','$Password','$Business_Website','$Business_experience_year','$Business_Address','$Business_contact',' $Business_city','$Business_state','$Business_image_name',$Business_Description')";
    
   //     if(mysqli_query($connect_db,$sql_add))
   //     {
   //       echo"yes";
   //     }
   //     else{
           ...
           <div class="inner_addbusinesspage">
              ...
              <form action=./profile_page.php method=post>
                 ...
                 <div class="file_input_holder">
                  <div class="please">
                   <input name="Business_image_name" multiple type="file" class="file_input">
